...
const SHOTS = [
  { ...SHOT, angle: 20, origin: { x: 0, y: 1 } },
  { ...SHOT, angle: 160, origin: { x: 1, y: 1 } },
];

/**
 * What makes the row of a birthday greeting different from every other row:
 * a surface of overlapping colour clouds and confetti above it. Both stay
 * behind the text of the row — see the `isolate` of the list item.
 *
...
export const BirthdayDecoration = () => {
  ...
  return (
    <>
      <span
        data-birthday-background
        aria-hidden="true"
        className="background-birthday pointer-events-none absolute inset-0 -z-20"
      />
