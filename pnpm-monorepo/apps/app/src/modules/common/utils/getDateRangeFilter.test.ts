...
describe("get date range filter", () => {
  ...
  test("keeps the end bound a full day across the spring transition", () => {
     ...
     */
    expect(getDateRangeFilter(null, "2026-03-29").lt?.toISOString()).toBe(
