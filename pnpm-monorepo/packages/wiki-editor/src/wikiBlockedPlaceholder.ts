...
/**
 * Placeholder for embed-like nodes whose src failed validation. All blocked
 ...
 * attribute (data-wiki-embed, data-wiki-iframe, data-youtube-video) is
 * omitted, so copied placeholders paste as plain content, not as the node.
 */
