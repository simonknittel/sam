...
export const Textarea = (props: Props) => {
  ...
  return (
    <>
      ...
      <textarea
        className={clsx(
          "p-2 rounded-secondary bg-neutral-900 border border-neutral-800 w-full h-32 mt-2 align-middle focus-visible:outline-2 outline-interaction-700 outline-offset-4",
          classNameTextarea,
        )}
        id={id}
        {...rest}
