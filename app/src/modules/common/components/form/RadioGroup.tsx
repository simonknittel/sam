        ...
        {items.map((item, index) => (
          <div key={item.value}>
            ...
            <label
              ...
              className={clsx(
                "border border-brand-red-500 min-h-8 py-1 px-2 flex items-center justify-center gap-2 cursor-pointer text-brand-red-500 hover:text-brand-red-300 hover:border-brand-red-300 peer-focus-visible:outline-solid peer-focus-visible:outline-1 peer-focus-visible:outline-offset-1 peer-aria-checked:bg-brand-red-500 peer-aria-checked:text-white text-sm",
                {
                  "rounded-l": index === 0,
