...
export const Button2 = <E extends ElementType = "button">({
  ...
  return (
    <Component
      className={clsx(
        "flex items-center justify-center rounded-secondary disabled:grayscale disabled:opacity-50 gap-1 min-h-8 py-1 px-2 text-sm font-normal [&>svg]:text-xs uppercase font-mono enabled:cursor-pointer",
        {
